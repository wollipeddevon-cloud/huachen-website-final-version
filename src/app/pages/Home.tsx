...
const parallaxImages = [
  {
    src: '/images/huachen-gate.jpg',
    alt: '广德华辰大门 - Huachen Factory Gate',
  },
  {
    src: '/images/latest-news-2.jpg',
    alt: 'Latest news',
  },
  {
    src: '/images/why-we-lead-2.jpg',
    alt: 'Why we lead - Dow partnership',
  },
  {
    src: '/images/market-entry-compliance-2.jpg',
    alt: 'Market entry and compliance',
  },
  {
    src: '/images/accreditation-rapid-growth-3.jpg',
    alt: 'Accreditation and rapid growth',
  },
  {
    src: '/images/why-we-lead-3.jpg',
    alt: 'Why we lead - Production power',
  },
  {
    src: '/images/last-picture.jpg',
    alt: 'Huachen facility',
  },
];


const ParallaxShowcase = () => (
  <section className="relative bg-slate-900" style={{ position: 'relative' }}>
    <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-white to-transparent z-10 pointer-events-none" />

    <div className="relative" style={{ zIndex: 1 }}>
      <div className="sticky top-0 z-20 flex items-center justify-center h-screen pointer-events-none">
        <div className="text-center flex flex-col items-center gap-2">
          <div className="w-[200px] h-[20px] md:w-[250px] md:h-[24px] mb-1">
            <VaporizeTextCycle
              texts={["A Visual Journey", "A Story of Precision", "A Legacy of Quality"]}
              font={{
          ...
          <div className="w-[600px] h-[80px] md:w-[800px] md:h-[100px]">
            <VaporizeTextCycle
              texts={["Our World in Focus", "Excellence in Every Thread", "Innovation Meets Craft"]}
              font={{
    ...
    <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-slate-100 to-transparent z-10 pointer-events-none" />
  </section>
);
